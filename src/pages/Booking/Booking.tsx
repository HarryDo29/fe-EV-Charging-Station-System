...
const Booking = () => {
  ...
  return (
    <div className='relative w-screen h-screen overflow-hidden'>
      ...
      <div
        className={`absolute top-4 left-12 z-[1000] min-w-[400px] max-w-[600px] ${searchStations.length > 0 ? 'h-[calc(100vh-2rem)] max-h-[85vh] bg-white p-0 m-0' : ''} rounded-4xl shadow-lg flex flex-col`}
      >
        <Search
          query={query}
          setQuery={setQuery}
