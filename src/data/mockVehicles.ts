...
const initialVehicles: Vehicle[] = [
  {
    ...
    car_maker: 'Tesla',
    models: 'Model 3',
    license_plate: 'TS-123456',
    connector_type: ConnectorType.TYPE1,
    battery_capacity_kwh: 60,
    charging_power_kw: 100,
    status: true
  },
  {
    id: '2',
  ...
  },
  {
    ...
    car_maker: 'VinFast',
    models: 'VF6',
    license_plate: 'VF6-123456',
    connector_type: ConnectorType.GBT,
    battery_capacity_kwh: 60,
    charging_power_kw: 89,
    status: true
  },
  {
    id: '4',
